...
public class BooksList extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                BooksList booksListPage = new BooksList();
                booksListPage.setResizable(false);
                booksListPage.setTitle("LibraryManagementApp");
                ImageIcon img = new ImageIcon("C:\\Users\\danie\\OneDrive\\Desktop\\book.png");
                booksListPage.setIconImage(img.getImage());
                booksListPage.setVisible(true);
            }
        });
    }
